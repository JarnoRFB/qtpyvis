        ...
        for idx, layer in reversed(list(enumerate(self.model.layers))):
            ...
            if isinstance(layer, Dense):
                ...
                for r, c in np.ndindex(layer.output_shape[1:3]):
                    ...
                    local_pre_activation = activation[r:r+layer.nb_row  ,c:c+layer.nb_col  ,np.newaxis,:] * W
                    ...
                    global_pre_activation = local_pre_activation.sum((0,1,3)) + B
                    ...
                    relevance[r:r+layer.nb_row,c:c+layer.nb_col,:] += relevance_matrix.sum(3)
